...
var host = "35.247.64.133";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "kayla";         //username (change to match your db)
var password = "cheesecakeCS341";  //password (change to match your db, yes this is very poor practice)
